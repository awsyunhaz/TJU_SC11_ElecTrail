...
//    Endian       =  little
//    Source file  =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\lib\LPLD\DEV\OLED.c
//    Command line =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\lib\LPLD\DEV\OLED.c
//        -D LPLD_K60 -lCN
...
//        ARM_MATH_CM4
//    List file    =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\project\TJU_SC11_ElecTrail_A车\iar\FLASH\List\OLED.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  328   DC_OUT = 1;
        MOVS     R2,#+1
        LDR.W    R3,??DataTable7  ;; 0x43fe103c
        STR      R2,[R3, #+0]
//  329   asm("nop"); 
        nop
//  330   D0_OUT = 0;
        MOVS     R2,#+0
        LDR.W    R3,??DataTable7_1  ;; 0x43fe1030
        STR      R2,[R3, #+0]
//  331   asm("nop");    
        nop
        B.N      ??LCD_WrDat_0
...
??LCD_WrDat_1:
        MOVS     R2,#+0
        LDR.W    R3,??DataTable7_2  ;; 0x43fe1034
        STR      R2,[R3, #+0]
//  338     D0_OUT = 1;
??LCD_WrDat_2:
        MOVS     R2,#+1
...
//  448   D0_OUT=1;
        MOVS     R0,#+1
        LDR.W    R1,??DataTable7_1  ;; 0x43fe1030
        STR      R0,[R1, #+0]
//  449   D0_OUT=0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable7_1  ;; 0x43fe1030
...
//  450   D1_OUT=1;
        MOVS     R0,#+1
        LDR.W    R1,??DataTable7_2  ;; 0x43fe1034
        STR      R0,[R1, #+0]
//  451   D1_OUT=0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable7_2  ;; 0x43fe1034
...
//  452   DC_OUT=1;
        MOVS     R0,#+1
        LDR.W    R1,??DataTable7  ;; 0x43fe103c
        STR      R0,[R1, #+0]
//  453   DC_OUT=0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable7  ;; 0x43fe103c
...
//  454   RST_OUT=1;
        MOVS     R0,#+1
        LDR.W    R1,??DataTable7_3  ;; 0x43fe1038
        STR      R0,[R1, #+0]
//  455   RST_OUT=0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable7_3  ;; 0x43fe1038
...
//  471   LCD_WrCmd(0xcf); // Set SEG Output Current Brightness
        MOVS     R0,#+207
        BL       LCD_WrCmd
//  472   LCD_WrCmd(0xa0);//--Set SEG/Column Mapping     0xa0左右反置 0xa1正常
        MOVS     R0,#+160
        BL       LCD_WrCmd
//  473   LCD_WrCmd(0xc0);//Set COM/Row Scan Direction   0xc0上下反置 0xc8正常
        MOVS     R0,#+192
        BL       LCD_WrCmd
...
//  758 
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  759 void Draw_BMPV(uint8 x0,uint8 bmp[])
//  760 { 	
Draw_BMPV:
        PUSH     {R3-R7,LR}
        MOVS     R4,R0
...
//  761   uint8 x,y;
//  762   
//  763 //  if(y1%8==0) y=y1/8;      
//  764 //  else y=y1/8+1;
//  765   for(y=1;y<8;y++)
        MOVS     R6,#+1
        B.N      ??Draw_BMPV_0
//  766   {
//  767     LCD_Set_Pos(x0,7-y);				
//  768     for(x=x0;x<x0+50;x++)
//  769     {      
//  770       LCD_WrDat(bmp[8*(x-x0)+y-1]);	    	
??Draw_BMPV_1:
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        SUBS     R0,R7,R4
...
//  792   for(y=0;y<8;y++)
        ...
        B.N      ??full_bmpv_0
//  793   {
//  794     LCD_Set_Pos(0,7-y);
//  795     for(x=0;x<128;x++)
//  796     {
//  797       LCD_WrDat(bmp[8*x+y]);
??full_bmpv_1:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        LSLS     R0,R5,#+3
        UXTAB    R0,R0,R6
