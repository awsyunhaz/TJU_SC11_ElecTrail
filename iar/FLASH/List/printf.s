///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.2.7424/W32 for ARM       06/Jul/2016  19:37:50
// Copyright 1999-2014 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\lib\common\printf.c
//    Command line =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\lib\common\printf.c
//        -D LPLD_K60 -lCN
...
//        ARM_MATH_CM4
//    List file    =  
//        C:\Users\zyh\Desktop\飞思卡尔\软件组作业一（2015.11.23）\拉普兰德例程及OLED测试程序\project\TJU_SC11_ElecTrail_A车\iar\FLASH\List\printf.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  626 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  627 void oledprintf(uint8 x,uint8 y,const int8* fmt,...)
//  628 {
oledprintf:
        PUSH     {R3}
        PUSH     {R4,R5,LR}
...
//  629   int8 s[21];
//  630   va_list ap;
//  631   PRINTK_INFO info;
//  632   
//  633   /*
//  634   * Initialize the pointer to the variable length argument list.
//  635   */
//  636   if (s != 0)
        ADD      R0,SP,#+12
        CMP      R0,#+0
...
//  649 /********************************************************************/
        ...
        SECTION `.text`:CODE:NOROOT(1)
        THUMB
//  650 void oledprintfw(uint8 x,uint8 y,const int8* fmt,...)
//  651 {
oledprintfw:
        PUSH     {R3}
        PUSH     {R4,R5,LR}
...
//  652   int8 s[21];
//  653   va_list ap;
//  654   PRINTK_INFO info;
//  655   
//  656   /*
//  657   * Initialize the pointer to the variable length argument list.
//  658   */
//  659   if (s != 0)
        ADD      R0,SP,#+12
        CMP      R0,#+0
